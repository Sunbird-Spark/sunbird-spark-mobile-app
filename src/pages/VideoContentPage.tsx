                ...
                <div className="video-container">
                    <div className="video-hero">
                        ...
                        <div className="video-player-placeholder">
                            <img src="https://images.pexels.com/photos/3913025/pexels-photo-3913025.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Video Thumbnail" className="video-thumbnail" />
                            ...
                            {[1, 2, 3, 4, 5].map((item, index) => (
                                <div key={item} className="related-video-card">
                                    <div className="rv-thumbnail-wrapper">
                                        <img
                                            src={index % 2 === 0 ? "https://images.pexels.com/photos/3153198/pexels-photo-3153198.jpeg?auto=compress&cs=tinysrgb&w=400" : "https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=400"}
                                            alt="Thumbnail"
                    ...
                    <div className="section related-content-section">
                        ...
                        <div className="horizontal-scroll-container">
                            <div className="content-card standard-card">
                                <img src="https://images.pexels.com/photos/9026290/pexels-photo-9026290.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Course" className="card-img" />
                            ...
                            <div className="content-card standard-card">
                                <img src="https://images.pexels.com/photos/2582937/pexels-photo-2582937.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Textbook" className="card-img" />
