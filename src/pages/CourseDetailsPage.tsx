...
const RightArrowIcon = () => (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6 0L4.9425 1.0575L9.1275 5.25H0V6.75H9.1275L4.9425 10.9425L6 12L12 6L6 0Z" fill="var(--ion-color-primary)" />
    </svg>
);
                    ...
                    <div className="related-content-container">
                        {relatedItems.map(item => (
                            <div
                                ...
                                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') history.push(`/video/${item.id}`); }}
                            >
