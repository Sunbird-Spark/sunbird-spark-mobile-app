...
import { homeOutline, home, personOutline } from 'ionicons/icons';
...
const HelpSupportIcon: React.FC = () => (
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    labelKey: 'myLearning',
    renderIcon: () => <MyLearningIcon />,
  },
  {
    id: 'explore',
    path: '/explore',
    labelKey: 'explore',
    renderIcon: () => <ExploreIcon />,
  },
  {
    id: 'helpAndSupport',
    path: '/support',
    labelKey: 'navSupport',
    renderIcon: () => <HelpSupportIcon />,
  },
  {
    id: 'profile',
    path: '/profile',
