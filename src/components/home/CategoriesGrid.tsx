...
const IconScreen = () => (
    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <clipPath id="clip_screen"><rect width="17" height="16" fill="white"/></clipPath>
        </defs>
    </svg>
);
...
const ICON_BY_NAME: Array<{ keywords: string[]; icon: React.ReactElement }> = [
    ...
    { keywords: ['it', 'development', 'tech', 'coding', 'programming'], icon: <IconCode /> },
